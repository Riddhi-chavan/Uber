      ...
      <div class="relative mt-12 w-full max-w-lg sm:mt-10">
        ...
        <div
          ...
          <div class="flex flex-col p-6">
            ...
            <p class="mt-1.5 text-sm font-medium text-black/50">Welcome back, enter your credentials to continue.
            </p>
          </div>
          <div class="p-6 py-10 pt-0">
            <form onSubmit={(e) => {
              ...
              <div>
                <div>
                  <div
                    class="group relative rounded-lg border focus-within:border-gray-200 px-3  duration-200 focus-within:ring focus-within:ring-sky-300/30">
